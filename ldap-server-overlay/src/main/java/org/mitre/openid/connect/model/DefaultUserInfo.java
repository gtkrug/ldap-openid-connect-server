...
public class DefaultUserInfo implements UserInfo {
	...
	private transient JsonObject src; // source JSON if this is loaded remotely
        ...
        private String  ori;
        private Boolean cfr;
        private String  aal;    // May be conveyed via vot.
        private String  ial;    // May be conveyed via vot.
        private String  fedid;
        private String  idpid;  // Not sure we want this?
	...
	public void setAddress(Address address) {
        ...
        /*
         * NIEF Claims  jk90, jkrug, krug - 2018-05-23
         */ 

	/* (non-Javadoc)
	 * @see org.mitre.openid.connect.model.UserInfo#getNiefPso()
	 */
	@Override
	@Basic
	@Column(name="nief_pso")
	public Boolean getNiefPso() {
		return pso;
	}
	/* (non-Javadoc)
	 * @see org.mitre.openid.connect.model.UserInfo#setNiefPso(java.lang.Boolean)
	 */
	@Override
	public void setNiefPso(Boolean pso) {
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefLeo()
         */
        @Override
        @Basic
        @Column(name="nief_leo")
        public Boolean getNiefLeo() {
                return leo;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefLeo(java.lang.Boolean)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNief28CFR()
         */
        @Override
        @Basic
        @Column(name="nief_cfr")
        public Boolean getNief28CFR() {
                return cfr;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNief28CFR(java.lang.Boolean)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefOri()
         */
        @Override
        @Basic
        @Column(name="nief_ori")
        public String getNiefOri() {
                return ori;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefOri(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefAal()
         */
        @Override
        @Basic
        @Column(name="nief_aal")
        public String getNiefAal() {
                return aal;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefAal(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefIal()
         */
        @Override
        @Basic
        @Column(name="nief_ial")
        public String getNiefIal() {
                return ial;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefIal(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefFedId()
         */
        @Override
        @Basic
        @Column(name="nief_fedid")
        public String getNiefFedId() {
                return fedid;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefFedId(java.lang.String)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#getNiefIdpId()
         */
        @Override
        @Basic
        @Column(name="nief_idpid")
        public String getNiefIdpId() {
                return idpid;
        }
        /* (non-Javadoc)
         * @see org.mitre.openid.connect.model.UserInfo#setNiefIdpId(java.lang.String)
         */
        @Override
	...
	public JsonObject toJson() {
		if (src == null) {
			...
			obj.addProperty("phone_number_verified", this.getPhoneNumberVerified());
                        ...
                        // NIEF Claims
                        obj.addProperty("pso", this.getNiefPso ());
                        obj.addProperty("leo", this.getNiefLeo ());
                        obj.addProperty("ori", this.getNiefOri ());
                        obj.addProperty("cfr", this.getNief28CFR ());
                        obj.addProperty("aal", this.getNiefAal ());
                        obj.addProperty("ial", this.getNiefIal ());
                        obj.addProperty("fedid", this.getNiefFedId ());
                        obj.addProperty("idpid", this.getNiefIdpId ());
	...
	public static UserInfo fromJson(JsonObject obj) {
		...
		ui.setPhoneNumberVerified(obj.has("phone_number_verified") && obj.get("phone_number_verified").isJsonPrimitive() ? obj.get("phone_number_verified").getAsBoolean() : null);
                ...
                // Set NIEF String Claims
                ui.setNiefOri (nullSafeGetString(obj, "ori"));
                ui.setNiefAal (nullSafeGetString(obj, "aal"));
                ui.setNiefIal (nullSafeGetString(obj, "ial"));
                ui.setNiefFedId (nullSafeGetString(obj, "fedid"));
                ui.setNiefIdpId (nullSafeGetString(obj, "idpid"));

                // Set NIEF Boolean Claims
		ui.setNiefLeo(obj.has("leo") && obj.get("leo").isJsonPrimitive() ? obj.get("leo").getAsBoolean() : null);
		ui.setNiefPso(obj.has("pso") && obj.get("pso").isJsonPrimitive() ? obj.get("pso").getAsBoolean() : null);
		ui.setNief28CFR(obj.has("cfr") && obj.get("cfr").isJsonPrimitive() ? obj.get("cfr").getAsBoolean() : null);
	...
	public int hashCode() {
		...
		result = prime * result + ((zoneinfo == null) ? 0 : zoneinfo.hashCode());
                ...
                // TBD - Do we want the hash being updated based on NIEF attributes?
		return result;
	}
