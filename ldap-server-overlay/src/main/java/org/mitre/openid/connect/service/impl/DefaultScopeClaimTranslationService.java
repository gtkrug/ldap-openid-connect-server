...
public class DefaultScopeClaimTranslationService implements ScopeClaimTranslationService {
	...
	public DefaultScopeClaimTranslationService() {
		...
		scopesToClaims.put("profile", "birthdate");
                ...
                // NIEF - jk90, krug, jkrug 2018-05-23
		scopesToClaims.put("nief", "leo");
		scopesToClaims.put("nief", "pso");
		scopesToClaims.put("nief", "cfr");
		scopesToClaims.put("nief", "aal");
		scopesToClaims.put("nief", "ial");
		scopesToClaims.put("nief", "ori");
		scopesToClaims.put("nief", "fedid");
		scopesToClaims.put("nief", "idpid");
